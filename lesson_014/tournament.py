...
# TODO: таб - это не просто 3-4 пробела.
            ...
            with open(self.output_file, 'w', encoding='utf8') as output_file:
                for line in input_file:
                    ...
                    if tour_start:
                        ...
                        # TODO: если что, 2 строки выше можно заменить на max(...)
                        #  Т.к. сравнение работает, мы можем использовать max|min|lst.sorted.
                        #  .
                        #  А вообще два if`а выше стоит объединить в один.
