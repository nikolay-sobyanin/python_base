...
def draw_bubble(point, radius, step, color, width):
    for _ in range(3):
...
for x in range(100, (quantity_bubbles * 100 + 1), 100):
    ...
    draw_bubble(point=point_2, radius=20, step=5, color=sd.COLOR_RED, width=2)
sd.sleep(seconds=2)
...
for y in range(100, (3 * 100 + 1), 100):
    for x in range(100, (quantity_bubbles * 100 + 1), 100):
        ...
        draw_bubble(point=point_3, radius=20, step=5, color=sd.COLOR_GREEN, width=1)
sd.sleep(seconds=2)
...
for _ in range(100):
    ...
    draw_bubble(point=random_point, radius=random_radius, step=5, color=random_color, width=1)
