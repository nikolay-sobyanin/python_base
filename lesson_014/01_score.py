...
def main():
    parser = argparse.ArgumentParser(description="Get player's score. --name --result")
    parser.add_argument('--name', required=True, type=str, help='Name')
    parser.add_argument('--result', required=True, type=str, help='From')
