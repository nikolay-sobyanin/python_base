...
class LetterStatistics:
    ...
    def collect_statistics(self):
        ...
        # TODO: сортировка и тут
        self.sort()
        self.print_statistics()

    def print_statistics(self):
        # TODO: и тут. 2 раза. почему?
        self.sort()
...
while True:
    # TODO: у numerate есть второй параметр, который по умолчанию 0. Это номер с которого будут нумеровать i.
    #  Можно написать enumerate(...., 1)
    for i, elm in enumerate(list_sort):
        # TODO: тогда тут можно будет убрать "+ 1"
    ...
    # TODO: да, т.к. это отдельные независимые объекты и даже классы
    ...
    # TODO: почему сделано именно так, и почему мы парсинг данных повторяется?
    ...
    # TODO: при запуске программы, при инициализации Менеджера, тип сортировки, как правило, берут из конфига, в котором
