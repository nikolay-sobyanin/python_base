...
class ImageMarker:
    ...
    def __init__(self, date, weather, temperature):
        ...
        # TODO а) раз image находится в текущей папке, то относительный путь должен начинаться с неё, то есть
        #  WeatherEngine лишняя папка в этом пути
        #  б) Имена файлов надо присваивать константам и использовать в основном коде только их.
